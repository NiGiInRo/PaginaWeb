...
public class ServletLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession sesionUsuario = request.getSession();
        Abogado _sesionUsuario = (Abogado)sesionUsuario.getAttribute("Email");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Abogado datosUsuario = new Abogado();
        datosUsuario.setEmail(login);
        datosUsuario.setContrasena(pass);
        System.out.println(datosUsuario);
        
        //Validaciones
        DAOAbogado userDao = new DAOAbogado();
        Abogado sesion = userDao.validar(datosUsuario);
        HttpSession sesionUsuario = request.getSession();
        Abogado _sesionUsuario = (Abogado)sesionUsuario.getAttribute("Email");
        if(_sesionUsuario==null){
